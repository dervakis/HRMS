...
import { BookmarkCheck, Briefcase, BriefcaseBusiness, CalendarCheck, Files, FileText, Gamepad2, History, Home, IndianRupee, Landmark, Mail, Network, Plane, Settings, Share2, ShieldCheck, Swords, Trophy, Wallet } from 'lucide-react';
      ...
      <SidebarItems>
        <SidebarItemGroup>
          ...
          <NavLink to='/achievement'>
              {
                ({ isActive }: { isActive: boolean }) => (
                <SidebarItem icon={Trophy} className={isActive ? 'bg-blue-300' : ''}>
                  Achievement
                </SidebarItem>
              )}
          </NavLink>
